...
BOOST_PYTHON_MODULE(_cmsgemos_gempython) {
  ...
  bpy::class_<gem::hw::GEMHwDevice, boost::noncopyable>("GEMHwDevice",
                                                        bpy::no_init)
      .def("getLoggerName", &gem::hw::GEMHwDevice::getLoggerName)
      .def("readReg",
           static_cast<uint32_t (gem::hw::GEMHwDevice::*)(std::string const &)>(
               &gem::hw::GEMHwDevice::readReg))
      .def("readReg",
           static_cast<uint32_t (gem::hw::GEMHwDevice::*)(uint32_t const &)>(
               &gem::hw::GEMHwDevice::readReg))
      .def("readReg",
           static_cast<uint32_t (gem::hw::GEMHwDevice::*)(std::string const &,
                                                          std::string const &)>(
               &gem::hw::GEMHwDevice::readReg))
      .def("writeReg",
           static_cast<void (gem::hw::GEMHwDevice::*)(std::string const &,
                                                      uint32_t const)>(
               &gem::hw::GEMHwDevice::writeReg))
      .def("writeReg",
           static_cast<void (gem::hw::GEMHwDevice::*)(uint32_t const &,
                                                      uint32_t const)>(
               &gem::hw::GEMHwDevice::writeReg))
      .def("writeReg",
           static_cast<void (gem::hw::GEMHwDevice::*)(std::string const &,
  ...
  bpy::class_<gem::hw::HwGenericAMC, bpy::bases<gem::hw::GEMHwDevice>,
              boost::noncopyable>(
      "HwGenericAMC", bpy::init<const std::string &, const std::string &>())
      .def(bpy::init<const std::string &, const std::string &,
                     const std::string &>())
      ...
      .def("getSupportedOptoHybrids",
           &gem::hw::HwGenericAMC::getSupportedOptoHybrids)
      .def("supportsGBTLink", &gem::hw::HwGenericAMC::supportsGBTLink)
      .def("supportsTriggerLink", &gem::hw::HwGenericAMC::supportsTriggerLink)
      .def("LinkStatus", &gem::hw::HwGenericAMC::LinkStatus)
      .def("LinkReset", &gem::hw::HwGenericAMC::LinkReset)
      .def("ResetLinks", &gem::hw::HwGenericAMC::ResetLinks)
      .def("setTrigSource", &gem::hw::HwGenericAMC::setTrigSource)
      .def("getTrigSource", &gem::hw::HwGenericAMC::getTrigSource)
      .def("setSBitSource", &gem::hw::HwGenericAMC::setSBitSource)
      .def("getSBitSource", &gem::hw::HwGenericAMC::getSBitSource)
      .def("getIPBusCounters", &gem::hw::HwGenericAMC::getIPBusCounters)
      ...
      .def("resetIPBusCounters", &gem::hw::HwGenericAMC::resetIPBusCounters)
      ...
      .def("enableDAQLink", &gem::hw::HwGenericAMC::enableDAQLink)
      .def("disableDAQLink", &gem::hw::HwGenericAMC::disableDAQLink)
      .def("setZS", &gem::hw::HwGenericAMC::setZS)
      .def("disableZS", &gem::hw::HwGenericAMC::disableZS)
      .def("resetDAQLink", &gem::hw::HwGenericAMC::resetDAQLink)
      ...
      .def("getDAQLinkDisperErrors",
           &gem::hw::HwGenericAMC::getDAQLinkDisperErrors)
      .def("getDAQLinkNonidentifiableErrors",
           &gem::hw::HwGenericAMC::getDAQLinkNonidentifiableErrors)
      ...
      .def("getDAQLinkInputTimeout",
           &gem::hw::HwGenericAMC::getDAQLinkInputTimeout)
      .def("getDAQLinkRunType", &gem::hw::HwGenericAMC::getDAQLinkRunType)
      .def("getDAQLinkRunParameters",
           &gem::hw::HwGenericAMC::getDAQLinkRunParameters)
      .def("getDAQLinkRunParameter",
           &gem::hw::HwGenericAMC::getDAQLinkRunParameter)
      .def("setDAQLinkInputTimeout",
           &gem::hw::HwGenericAMC::setDAQLinkInputTimeout)
      .def("setDAQLinkRunType", &gem::hw::HwGenericAMC::setDAQLinkRunType)
      .def("setDAQLinkRunParameters",
           &gem::hw::HwGenericAMC::setDAQLinkRunParameters)
      .def("setDAQLinkRunParameter",
           &gem::hw::HwGenericAMC::setDAQLinkRunParameter)
      ...
      .def("setL1AEnable", &gem::hw::HwGenericAMC::setL1AEnable)
      ...
      .def("getTTCErrorCount", &gem::hw::HwGenericAMC::getTTCErrorCount)
      ...
      .def("scaHardResetEnable", &gem::hw::HwGenericAMC::scaHardResetEnable)
      .def("triggerReset", &gem::hw::HwGenericAMC::triggerReset)
      .def("triggerCounterReset", &gem::hw::HwGenericAMC::triggerCounterReset)
      .def("getOptoHybridKillMask",
           &gem::hw::HwGenericAMC::getOptoHybridKillMask)
      .def("setOptoHybridKillMask",
           &gem::hw::HwGenericAMC::setOptoHybridKillMask)
      .def("getORTriggerRate", &gem::hw::HwGenericAMC::getORTriggerRate)
      .def("getORTriggerCount", &gem::hw::HwGenericAMC::getORTriggerCount)
      .def("getOptoHybridTriggerRate",
           &gem::hw::HwGenericAMC::getOptoHybridTriggerRate)
      .def("getOptoHybridTriggerCount",
           &gem::hw::HwGenericAMC::getOptoHybridTriggerCount)
      .def("getOptoHybridClusterRate",
           &gem::hw::HwGenericAMC::getOptoHybridClusterRate)
      .def("getOptoHybridClusterCount",
           &gem::hw::HwGenericAMC::getOptoHybridClusterCount)
      .def("getOptoHybridDebugLastCluster",
           &gem::hw::HwGenericAMC::getOptoHybridDebugLastCluster)
      .def("getOptoHybridTriggerLinkCount",
           &gem::hw::HwGenericAMC::getOptoHybridTriggerLinkCount)
      ...
      .def("linkReset", &gem::hw::HwGenericAMC::linkReset);
  bpy::class_<gem::hw::optohybrid::HwOptoHybrid,
              bpy::bases<gem::hw::GEMHwDevice>, boost::noncopyable>(
      "HwOptoHybrid", bpy::init<const std::string &, const std::string &>())
      .def(bpy::init<const std::string &, const std::string &,
                     const std::string &>())
      .def_readonly("MAX_VFATS", &gem::hw::utils::MAX_VFATS)
      .def_readonly("ALL_VFATS_BCAST_MASK",
                    &gem::hw::utils::ALL_VFATS_BCAST_MASK)
      .def_readonly("ALL_VFATS_DATA_MASK", &gem::hw::utils::ALL_VFATS_DATA_MASK)
      .def("getFirmwareVersion",
           &gem::hw::optohybrid::HwOptoHybrid::getFirmwareVersion)
      .def("getFirmwareVersionString",
           &gem::hw::optohybrid::HwOptoHybrid::getFirmwareVersionString)
      .def("getFirmwareDate",
           &gem::hw::optohybrid::HwOptoHybrid::getFirmwareDate)
      .def("getFirmwareDateString",
           &gem::hw::optohybrid::HwOptoHybrid::getFirmwareDateString)
      ...
      .def("LinkStatus", &gem::hw::optohybrid::HwOptoHybrid::LinkStatus)
      .def("LinkReset", &gem::hw::optohybrid::HwOptoHybrid::LinkReset)
      .def("ResetLinks", &gem::hw::optohybrid::HwOptoHybrid::ResetLinks)
      ...
      .def("getTrigSource", &gem::hw::optohybrid::HwOptoHybrid::getTrigSource)
      .def("setLoopbackSBitSource",
           &gem::hw::optohybrid::HwOptoHybrid::setLoopbackSBitSource)
      .def("getLoopbackSBitSource",
           &gem::hw::optohybrid::HwOptoHybrid::getLoopbackSBitSource)
      .def("setTriggerThrottle",
           &gem::hw::optohybrid::HwOptoHybrid::setTriggerThrottle)
      .def("getTriggerThrottle",
           &gem::hw::optohybrid::HwOptoHybrid::getTriggerThrottle)
      .def("setHDMISBitSource",
           static_cast<
               void (gem::hw::optohybrid::HwOptoHybrid::*)(uint32_t const)>(
               &gem::hw::optohybrid::HwOptoHybrid::setHDMISBitSource))
      .def("setHDMISBitSource",
           static_cast<void (
               gem::hw::optohybrid::HwOptoHybrid::*)(std::array<uint8_t, 6>)>(
               &gem::hw::optohybrid::HwOptoHybrid::setHDMISBitSource))
      .def("getHDMISBitSource",
           &gem::hw::optohybrid::HwOptoHybrid::getHDMISBitSource)
      .def("setHDMISBitMode",
           &gem::hw::optohybrid::HwOptoHybrid::setHDMISBitMode)
      .def("getHDMISBitMode",
           &gem::hw::optohybrid::HwOptoHybrid::getHDMISBitMode)
      .def("getReferenceClock",
           &gem::hw::optohybrid::HwOptoHybrid::getReferenceClock)
      .def("isQPLLLocked", &gem::hw::optohybrid::HwOptoHybrid::isQPLLLocked)
      .def("isQPLLFPGAPLLLocked",
           &gem::hw::optohybrid::HwOptoHybrid::isQPLLFPGAPLLLocked)
      ...
      .def("getFPGAMaxVccInt",
           &gem::hw::optohybrid::HwOptoHybrid::getFPGAMaxVccInt)
      .def("getFPGAMinVccInt",
           &gem::hw::optohybrid::HwOptoHybrid::getFPGAMinVccInt)
      .def("getFPGAVccAux", &gem::hw::optohybrid::HwOptoHybrid::getFPGAVccAux)
      .def("getFPGAMaxVccAux",
           &gem::hw::optohybrid::HwOptoHybrid::getFPGAMaxVccAux)
      .def("getFPGAMinVccAux",
           &gem::hw::optohybrid::HwOptoHybrid::getFPGAMinVccAux)
      ...
      .def("isLinkActive", &gem::hw::optohybrid::HwOptoHybrid::isLinkActive);
}
